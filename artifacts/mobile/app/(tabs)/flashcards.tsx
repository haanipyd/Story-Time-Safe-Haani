...
export default function FlashcardsScreen() {
  ...
  if (!currentCard) {
    return (
      <View style={[styles.root, { backgroundColor: "#FDF8EF" }]}>
        <View style={[styles.emptyState, { paddingTop: topPadding + 80 }]}>
  ...
  return (
    <View style={[styles.root, { backgroundColor: "#FDF8EF" }]}>
      ...
      <View style={[styles.header, { paddingTop: topPadding + 8 }]}>
        <Text style={[styles.headerTitle, { color: colors.navy }]}>Flashcards</Text>
      </View>
      ...
      <View style={[styles.topTabBar, { borderBottomColor: colors.muted }]}>
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <Text style={[styles.topTabText, { color: colors.mutedForeground }]}>🎧 AudioStory</Text>
        </TouchableOpacity>
        <View style={styles.topTabActive}>
          <Text style={[styles.topTabText, { color: colors.coral }]}>🃏 Flashcards</Text>
      ...
      <View style={styles.deckArea}>
        <View style={styles.deckContainer}>
          ...
          {/* Replay button (top-left, absolute over card) */}
      ...
      {/* Bottom Controls */}
      <View style={[styles.controls, { paddingBottom: bottomPadding + 16 }]}>
        <TouchableOpacity
